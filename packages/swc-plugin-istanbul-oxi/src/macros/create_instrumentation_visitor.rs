        ...
        impl<'a> $name<'a> {
            pub fn new(
                ...
                $name {
                    ...
                    comments,
                    cov,
                    cov_fn_ident: istanbul_oxi_instrument::create_coverage_fn_decl::COVERAGE_FN_IDENT.get().expect("Coverage fn Ident should be initialized already").clone(),
                    cov_fn_temp_ident: istanbul_oxi_instrument::create_coverage_fn_decl::COVERAGE_FN_TRUE_TEMP_IDENT.get().expect("Coverage fn Ident should be initialized already").clone(),
